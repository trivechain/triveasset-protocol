...
TriveAssetBuilder.prototype._addInputsForSendTransaction = function (txb, args) {
  ...
  txb.addOutput(coloredChange ? (args.coloredChangeAddress ? args.coloredChangeAddress : (Array.isArray(args.from) ? args.from[0] : args.from) ) : changeAddress ? changeAddress : (Array.isArray(args.from) ? args.from[0] : args.from), lastOutputValue)
  debug('success')
